...
class TestGetPlayerInfo:
    def test_returns_player_data_for_known_name(self):
        ...
        with patch("tools.players.find_players_by_full_name", return_value=mock_player):
    ...
    def test_returns_error_when_player_not_found(self):
        with patch("tools.players.find_players_by_full_name", return_value=[]):
            from tools import get_player_info
    ...
    def test_returns_all_players_when_name_is_empty(self):
        ...
        with patch("tools.players.get_players", return_value=mock_all):
            from tools import get_player_info
...
class TestGetTeamInfo:
    def test_returns_team_data_for_known_name(self):
        ...
        with patch("tools.teams.find_teams_by_full_name", return_value=mock_team):
    ...
    def test_returns_error_when_team_not_found(self):
        with patch("tools.teams.find_teams_by_full_name", return_value=[]):
            from tools import get_team_info
    ...
    def test_returns_all_teams_when_name_is_none(self):
        ...
        with patch("tools.teams.get_teams", return_value=mock_all):
            from tools import get_team_info
...
class TestGetPlayerCareerStats:
    ...
    def test_returns_career_summary(self):
        ...
        with patch("tools.playercareerstats.PlayerCareerStats", return_value=mock_career):
            from tools import get_player_career_stats
